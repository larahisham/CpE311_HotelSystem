...
File Structure
hs.cs: Main file containing all the classes and methods for managing the hotel system.
Classes
...
Log-in as Guest
Log-in as Manager
Sign-in as new Guest
Exit
How to Run
Clone the repository:
git clone https://github.com/larahisham/CpE311_HotelSystem.git
Open the project in an IDE that supports C# (e.g., Visual Studio).
Build and run the project.
Contact
For any questions or inquiries, please contact larahishamahmadby@gmail.com.
